 ...
 */
function SpeakerBanner({ publicState }: { publicState: PublicRoomState }) {
  ...
  return (
    <div className="speaker-banner">
      ...
      {speakerLine && <p className="speaker-banner-speaker">{speakerLine}</p>}
    </div>
  );
}
...
export function PublicGamePanel({
  ...
  return (
    <section className="card">
      ...
      <SpeakerBanner publicState={publicState} />
